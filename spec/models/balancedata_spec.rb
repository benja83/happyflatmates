RSpec.describe Bill, :type => :model do
  ...
  context 'balance_data' do
    ...
    before(:each) do
      ...
      @bill1 = Bill.create item: 'mercadona',price: 10.5, flat_id: @flat1.id, user_id: @user1.id
      @bill2 = Bill.create item: 'mercadona',price: 15.3, flat_id: @flat1.id, user_id: @user2.id
    end
    ...
    balances = Bill.balance_data
      expect(balances[0][:date]).to eq(Date.today)
      expect(balances[1][:date]).to eq(Date.today)
    end
    ...
    @bill3 = Bill.create item: 'mercadona',price: 30, flat_id: @flat2.id, user_id: @user3.id
